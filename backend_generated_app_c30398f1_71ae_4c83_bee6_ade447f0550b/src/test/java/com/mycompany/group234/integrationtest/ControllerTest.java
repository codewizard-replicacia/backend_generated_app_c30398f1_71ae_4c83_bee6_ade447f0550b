...
class ControllerTest {
  ...
  given()
   ...
   given()
            .when()
            .get("/generated_app/Drivers?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/generated_app/Drivers/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/generated_app/Routes?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/generated_app/Routes/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM generated_app.Bus");
    jdbcTemplate.execute("DELETE FROM generated_app.Trip");
    jdbcTemplate.execute("DELETE FROM generated_app.Driver");
    jdbcTemplate.execute("DELETE FROM generated_app.Route");
     jdbcTemplate.execute("DELETE FROM generated_app.BusDrivers");
     jdbcTemplate.execute("DELETE FROM generated_app.BusTrips");
